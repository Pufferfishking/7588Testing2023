...
public class PoofyProfiledPIDController {
    private PoofyPIDFController m_controller;
    ...
    public PoofyProfiledPIDController(double Kp, double Ki, double Kd,
        ...
        m_controller = new PoofyPIDFController(new PoofyPIDFCoefficients(Kp, Ki, Kd, 0, 0, 0, 0));
        m_controller = new PoofyPIDFController.Builder().addPID(Kp, Ki, Kd).build();
